...
- If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/starknet-innovation/starknet-start/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
- The commit style used by Starknet Start follows this pattern: `<package>: <commit message>`. For example, `core: change useAccount hook to...`.

#### **Did you fix whitespace, format code, or make a purely cosmetic patch?**

Changes that are cosmetic in nature and do not add anything substantial to the stability, functionality, or testability of Starknet Start will generally not be accepted.

#### **Do you have questions about the source code?**

- Ask any question about how to use Starknet Start [in the Discord community](https://discord.gg/m7B92CNFNt).

#### **Do you want to contribute to the Starknet Start documentation?**
...
```
git clone git@github.com:starknet-innovation/starknet-start.git
```
...
The project uses [oxlint](https://oxc.rs/docs/guide/usage/linter.html) for linting and [oxfmt](https://oxc.rs/docs/guide/usage/formatting.html) for formatting. You should install the appropriate extensions for your code editor.
