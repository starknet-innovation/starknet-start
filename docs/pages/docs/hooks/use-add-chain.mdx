...
import { useAddChain } from "@starknetfoundation/starknet-start-react";
...
- Type: `(args?: AddStarknetChainParameters) => Promise<boolean>`
...
- Type: `RequestArgs<"wallet_addStarknetChain"> | undefined`
