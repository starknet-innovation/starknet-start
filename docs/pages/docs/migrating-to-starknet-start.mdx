...
npm install @starknetfoundation/starknet-start-chains @starknetfoundation/starknet-start-providers @starknetfoundation/starknet-start-react starknet @starknet-io/get-starknet-core @starknet-io/get-starknet-modal @starknet-io/get-starknet-wallet-standard
```
...
yarn add @starknetfoundation/starknet-start-chains @starknetfoundation/starknet-start-providers @starknetfoundation/starknet-start-react starknet @starknet-io/get-starknet-core @starknet-io/get-starknet-modal @starknet-io/get-starknet-wallet-standard
```
...
```bash
npm install @starknet-io/get-starknet-ui
```
