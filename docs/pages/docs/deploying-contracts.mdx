...
```tsx
import { useAccount, useUniversalDeployerContract, useSendTransaction } from "@starknetfoundation/starknet-start-react";
...
function useUniversalDeployerContract(props?: {
  ...
  udc: StarknetTypedContract | undefined; // The UDC contract instance
};
```
