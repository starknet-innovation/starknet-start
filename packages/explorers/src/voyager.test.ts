...
describe("VoyagerExplorer", () => {
  it("should link to a block", () => {
    ...
    expect(
      ...
      `"https://voyager.online/block/0x06d7b5ecf23928af0a12daec0db203f85162588e42607e3379310febc8f072e9"`,
    );

    expect(explorer.block({ number: 2755646 })).toMatchInlineSnapshot(`"https://voyager.online/block/2755646"`);
  });
  ...
  it("should link to a transaction", () => {
    ...
    expect(
      ...
      `"https://voyager.online/tx/0x696393ca93411324a3b68c0ae45f39071be09cd9cc58e20180960835ab8fbfd"`,
    );
  });
  ...
  it("should link to a class", () => {
    ...
    expect(explorer.class("0x04ad3c1dc8413453db314497945b6903e1c766495a1e60492d44da9c2a986e4b")).toMatchInlineSnapshot(
      `"https://voyager.online/class/0x04ad3c1dc8413453db314497945b6903e1c766495a1e60492d44da9c2a986e4b"`,
    );
  });
});
